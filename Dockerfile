...
FROM composer:2.10.1 AS builder-composer

FROM docker.io/library/alpine:3.24.0 AS builder
...
FROM docker.io/library/alpine:3.24.0 AS base
...
FROM docker.io/library/nginx:1.31.1-alpine AS humhub_nginx
